-- Fix ensure_game_data_exists - remove non-existent inventory column
...
EXCEPTION
  WHEN OTHERS THEN
    -- Log error and re-raise to see what's happening
    RAISE NOTICE 'Error in ensure_game_data_exists for %: %', p_wallet_address, SQLERRM;
    RAISE;
END;
$$;