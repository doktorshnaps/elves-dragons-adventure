-- Fix the search_path warnings for security definer functions
...
-- Update the get_game_data_by_wallet function to auto-create if not exists with proper search_path
