-- Fix: Increase return limit for get_item_instances_by_wallet to handle large inventories
...
BEGIN
  ...
  LIMIT 10000; -- Increased from default 1000 to 10000 to handle large inventories
END;
$$;