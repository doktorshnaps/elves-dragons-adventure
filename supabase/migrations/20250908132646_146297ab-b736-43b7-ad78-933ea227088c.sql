-- Create a secure function to update game data by wallet
...
GRANT EXECUTE ON FUNCTION public.update_game_data_by_wallet(text, integer, jsonb, jsonb, jsonb, jsonb, integer, integer, boolean, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb) TO anon, authenticated;