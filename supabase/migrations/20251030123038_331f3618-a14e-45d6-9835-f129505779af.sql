-- Remove all versions of update functions with inventory parameter
DROP FUNCTION IF EXISTS public.update_game_data_by_wallet CASCADE;
DROP FUNCTION IF EXISTS public.update_game_data_by_wallet_v2 CASCADE;

-- Create clean update function WITHOUT inventory parameter
...
GRANT EXECUTE ON FUNCTION public.update_game_data_by_wallet_v2(
  text, integer, jsonb, jsonb, jsonb, integer, integer, boolean, 
