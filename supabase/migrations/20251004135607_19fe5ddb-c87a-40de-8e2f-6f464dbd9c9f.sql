-- Удаляем старые данные классов драконов
DELETE FROM public.dragon_class_multipliers;

-- Вставляем правильные классы драконов (от слабых к сильным)
...
('Необычный', 1.1, 1.1, 1.1, 1.1),
('Редкий', 1.2, 1.2, 1.2, 1.2),
('Эпический', 1.3, 1.3, 1.3, 1.3),
('Легендарный', 1.4, 1.4, 1.4, 1.4),
('Мифический', 1.5, 1.5, 1.5, 1.5),
('Этернал', 1.6, 1.6, 1.6, 1.6),
('Империал', 1.7, 1.7, 1.7, 1.7),
('Титан', 1.8, 1.8, 1.8, 1.8)
...
-- Переупорядочиваем классы героев (от слабых к сильным)
