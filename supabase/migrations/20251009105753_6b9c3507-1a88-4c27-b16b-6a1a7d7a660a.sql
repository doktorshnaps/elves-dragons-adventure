-- Update add_card_to_medical_bay function to use correct heal rate of 100 HP/min
CREATE OR REPLACE FUNCTION public.add_card_to_medical_bay(p_wallet_address text, p_card_instance_id uuid, p_healing_hours integer DEFAULT 2)
RETURNS uuid
LANGUAGE plpgsql
SECURITY DEFINER
...
DECLARE
  ...
  v_heal_rate integer := 100; -- 100 HP per minute (updated from 1)
