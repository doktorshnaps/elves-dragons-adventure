-- Fix admin_give_player_card to prevent duplicate inserts using idempotency
...
BEGIN
  ...
  -- Check for duplicate using idempotency key (card_data->>'id')
...
-- Clean up ALL existing duplicate admin cards across all wallets
