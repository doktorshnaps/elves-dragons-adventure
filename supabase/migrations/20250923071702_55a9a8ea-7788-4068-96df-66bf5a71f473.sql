-- Добавляем поле для отслеживания источника вайт-листа
ALTER TABLE public.whitelist 
ADD COLUMN whitelist_source TEXT DEFAULT 'manual',
ADD COLUMN nft_contract_used TEXT;
...
WHERE added_by_wallet_address = 'system_nft_checker';
