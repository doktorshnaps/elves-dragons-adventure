...
const dungeonInfo = [
  {
    ...
    enemies: [
      { name: "Морок", description: "Могущественный босс подземелья (5 уровень)" },
      { name: "Кристалспин и Скарлетстрайк", description: "Элитные враги (4 уровень)" },
      { name: "Грауграт, Дарксторм и Флиндо", description: "Сильные противники (3 уровень)" },
      { name: "Ветераны Драконидов", description: "Опытные воины (2 уровень)" },
      { name: "Драконид воины", description: "Базовые противники (1 уровень)" }
    ],
    loot: [
