...
export const translations = {
  ru: {
    ...
    dungeonSearch: {
      ...
      unfinishedDungeonTitle: 'Есть незавершённое подземелье',
      unfinishedDungeonMessage: 'Обнаружена активная сессия подземелья. Завершите её или сбросьте, чтобы начать новую.',
      resetActiveDungeon: 'Сбросить активное подземелье',
    ...
    battlePage: {
      ...
      waitForEnergy: 'Подождите, пока энергия восстановится',
      teamDefeated: 'Команда пала',
      noReward: 'Награда не начисляется',
      exit: 'Выйти',
      processingResults: 'Обработка результатов боя...',
    dungeonFinished: 'Подземелье завершено',
    finishedOnAnotherDevice: 'Подземелье было завершено на другом устройстве. Ваш бой больше не активен.',
    sessionLost: 'Соединение с сессией подземелья потеряно. Это могло произойти из-за сетевого сбоя или неактивности.',
    restoreBattle: 'Восстановить бой',
    restoreFailed: 'Не удалось восстановить',
    anotherDeviceActive: 'Активная сессия обнаружена на другом устройстве',
    closeDungeon: 'Закрыть подземелье',
      back: 'Назад',
      menu: 'Меню',
      surrender: 'Сдаться',
      leaveDungeon: 'Покинуть подземелье?',
      leaveDungeonWarning: 'Подземелье будет закрыто и весь прогресс будет утерян. При повторном входе вы начнете с первого уровня.',
      no: 'Нет',
      yes: 'Да',
      teamBattleLevel: 'Командный бой - Уровень',
      level: 'Уровень:',
      dungeonLevel: 'Подземелье · Ур.',
      yourTeam: 'Ваша команда',
      opponents: 'Противники',
      attack: 'Атака',
      autoBattle: 'Автобой',
      selectPairAndTarget: 'Выберите пару и цель для атаки',
      power: 'Сила',
      defense: 'Защита',
      health: 'Здоровье',
      yourTurn: 'Ваш ход',
      ...
      player: 'Игрок',
      monster: 'Монстр',
      selectTarget: 'Выберите цель для атаки',
      attackButton: 'Атаковать',
      stopAutoBattle: 'Стоп авто-бой',
      enemies: 'Враги',
      killed: 'УБИТ'
    }
  },
  en: {
    ...
    dungeonSearch: {
      ...
      unfinishedDungeonTitle: 'Unfinished Dungeon',
      unfinishedDungeonMessage: 'An active dungeon session was detected. Complete it or reset to start a new one.',
      resetActiveDungeon: 'Reset Active Dungeon',
    ...
    battlePage: {
      ...
      waitForEnergy: 'Wait for energy to recharge',
      teamDefeated: 'Team Defeated',
      noReward: 'No reward granted',
      exit: 'Exit',
      processingResults: 'Processing battle results...',
      dungeonFinished: 'Dungeon Completed',
      finishedOnAnotherDevice: 'Dungeon was finished on another device. Your battle is no longer active.',
      sessionLost: 'Connection to dungeon session lost. This may have occurred due to network issues or inactivity.',
      restoreBattle: 'Restore Battle',
      restoreFailed: 'Failed to restore',
      anotherDeviceActive: 'Active session detected on another device',
      closeDungeon: 'Close Dungeon',
      back: 'Back',
      menu: 'Menu',
      surrender: 'Surrender',
      leaveDungeon: 'Leave Dungeon?',
      leaveDungeonWarning: 'The dungeon will be closed and all progress will be lost. You will start from level 1 on re-entry.',
      no: 'No',
      yes: 'Yes',
      teamBattleLevel: 'Team Battle - Level',
      level: 'Level:',
      dungeonLevel: 'Dungeon · Lv.',
      yourTeam: 'Your Team',
      opponents: 'Opponents',
      attack: 'Attack',
      autoBattle: 'Auto Battle',
      selectPairAndTarget: 'Select pair and target to attack',
      power: 'Power',
      defense: 'Defense',
      health: 'Health',
      yourTurn: 'Your Turn',
      ...
      player: 'Player',
      monster: 'Monster',
      selectTarget: 'Select target to attack',
      attackButton: 'Attack',
      stopAutoBattle: 'Stop Auto Battle',
      enemies: 'Enemies',
      killed: 'KILLED'
    }
  }
