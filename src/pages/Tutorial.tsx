...
import { ArrowLeft, Swords, Shield, Hammer, MapPin, Users, Package, Crown, Heart, Sparkles, Gem, Building2, FlaskConical, ScrollText } from "lucide-react";
  ...
  const sections: SectionData[] = [
    {
      ...
      contentRu: (
        <div className="space-y-4">
          <p>Добро пожаловать в мир фэнтезийных карточных сражений! Эта игра сочетает в себе коллекционирование карт, стратегические бои и развитие базы.</p>
          
          <h4 className="font-bold text-yellow-400">Основные механики:</h4>
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Карты:</strong> Собирайте героев и драконов разной редкости</li>
            <li><strong>Подземелья:</strong> Проходите уровни и побеждайте монстров</li>
            <li><strong>Убежище:</strong> Развивайте здания и производите ресурсы</li>
            <li><strong>Крафт:</strong> Создавайте предметы и зелья</li>
            <li><strong>Квесты:</strong> Выполняйте задания за награды</li>
          </ul>
          
          <h4 className="font-bold text-yellow-400">Валюты:</h4>
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>ELL:</strong> Основная игровая валюта</li>
            <li><strong>Дерево, Камень, Железо:</strong> Ресурсы для строительства</li>
            <li><strong>NEAR:</strong> Криптовалюта для NFT операций</li>
          </ul>
        </div>
      ),
      contentEn: (
        <div className="space-y-4">
          <p>Welcome to the world of fantasy card battles! This game combines card collecting, strategic combat, and base building.</p>
          
          <h4 className="font-bold text-yellow-400">Core Mechanics:</h4>
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Cards:</strong> Collect heroes and dragons of different rarities</li>
            <li><strong>Dungeons:</strong> Clear levels and defeat monsters</li>
            <li><strong>Shelter:</strong> Develop buildings and produce resources</li>
            <li><strong>Crafting:</strong> Create items and potions</li>
            <li><strong>Quests:</strong> Complete tasks for rewards</li>
          </ul>
          
          <h4 className="font-bold text-yellow-400">Currencies:</h4>
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>ELL:</strong> Main game currency</li>
            <li><strong>Wood, Stone, Iron:</strong> Building resources</li>
            <li><strong>NEAR:</strong> Cryptocurrency for NFT operations</li>
          </ul>
        </div>
      )
    },
    {
      ...
      contentRu: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Герои:</strong> Основные боевые единицы с разными классами</li>
            <li><strong>Драконы:</strong> Мощные питомцы, усиливающие команду</li>
          </ul>
          ...
          <p>Каждая карта принадлежит к определённой фракции. Стихии взаимодействуют по принципу камень-ножницы-бумага, давая бонусы или штрафы к урону.</p>
        </div>
      ),
      contentEn: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Heroes:</strong> Main combat units with different classes</li>
            <li><strong>Dragons:</strong> Powerful pets that boost your team</li>
          </ul>
          ...
          <p>Each card belongs to a specific faction. Elements interact in a rock-paper-scissors manner, giving damage bonuses or penalties.</p>
        </div>
      )
    },
    {
      ...
      contentRu: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Атака:</strong> Герой наносит урон монстру (Сила + Магия - Защита врага)</li>
            <li><strong>Защита:</strong> Монстр контратакует, ваша защита снижает урон</li>
            <li><strong>Элементальные бонусы:</strong> +20% урона против слабой стихии, -20% против сильной</li>
          </ul>
      ...
      contentEn: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Attack:</strong> Hero deals damage to monster (Power + Magic - Enemy Defense)</li>
            <li><strong>Defense:</strong> Monster counterattacks, your defense reduces damage</li>
            <li><strong>Elemental bonuses:</strong> +20% damage against weak element, -20% against strong</li>
          </ul>
    ...
    },
    {
      ...
      contentRu: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Паучье Гнездо:</strong> Начальное подземелье, пауки (🕷️ Яд)</li>
            <li><strong>Логово Чёрного Дракона:</strong> Драконы и огненные враги (🔥 Огонь)</li>
            <li><strong>Пещера Забытых Душ:</strong> Нежить и призраки (💀 Тьма)</li>
            <li><strong>Ледяной Трон:</strong> Ледяные существа (❄️ Лёд)</li>
            <li><strong>Башня Тёмного Мага:</strong> Маги и элементали (⚡ Молния)</li>
            <li><strong>Подземелье Костяного Демона:</strong> Демоны (🦴 Кость)</li>
            <li><strong>Логово Морского Змея:</strong> Водные существа (🌊 Вода)</li>
            <li><strong>Пантеон Богов:</strong> Высшие существа (✨ Свет)</li>
          </ul>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="main-hall" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> +20 слотов инвентаря за уровень</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="sawmill" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> +10 дерева в час за уровень</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="quarry" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> +8 камня в час за уровень</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="barracks" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> Разблокирует улучшение до более высокой редкости</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="dragon-lair" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> Разблокирует улучшение драконов до более высокой редкости</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="medical" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> Увеличивает скорость лечения</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="forge" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> Увеличивает скорость ремонта</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="workshop" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Бонус:</strong> Разблокирует новые рецепты крафта</p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          
          <h4 className="font-bold text-yellow-400 mt-4">Рабочие:</h4>
          <p>Рабочих можно купить в магазине и назначить на здания для ускорения производства. После окончания времени работы рабочий исчезает.</p>
        </div>
      ),
      contentEn: (
        <div className="space-y-4">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="main-hall" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> +20 inventory slots per level</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="sawmill" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> +10 wood per hour per level</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="quarry" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> +8 stone per hour per level</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="barracks" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> Unlocks upgrade to higher rarity</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="dragon-lair" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> Unlocks dragon upgrade to higher rarity</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="medical" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> Increases healing speed</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="forge" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> Increases repair speed</p>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="workshop" className="border-white/20">
              ...
              <AccordionContent className="text-white/90">
                ...
                <p className="mt-2"><strong>Bonus:</strong> Unlocks new crafting recipes</p>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
          
          <h4 className="font-bold text-yellow-400 mt-4">Workers:</h4>
          <p>Workers can be purchased in the shop and assigned to buildings to speed up production. After work time ends, the worker disappears.</p>
        </div>
      )
    },
    {
      ...
      contentRu: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Зелья:</strong> Восстанавливают здоровье, усиливают характеристики</li>
            <li><strong>Оружие:</strong> Увеличивает силу атаки</li>
            <li><strong>Броня:</strong> Увеличивает защиту</li>
            <li><strong>Аксессуары:</strong> Различные бонусы</li>
            <li><strong>Материалы:</strong> Используются для других рецептов</li>
          </ul>
      ...
      contentEn: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Potions:</strong> Restore health, boost stats</li>
            <li><strong>Weapons:</strong> Increase attack power</li>
            <li><strong>Armor:</strong> Increase defense</li>
            <li><strong>Accessories:</strong> Various bonuses</li>
            <li><strong>Materials:</strong> Used for other recipes</li>
          </ul>
    ...
    },
    {
      ...
      contentRu: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Оружие:</strong> Бонус к силе и магии</li>
            <li><strong>Броня:</strong> Бонус к защите и здоровью</li>
            <li><strong>Аксессуар:</strong> Различные бонусы</li>
          </ul>
      ...
      contentEn: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Weapon:</strong> Power and magic bonus</li>
            <li><strong>Armor:</strong> Defense and health bonus</li>
            <li><strong>Accessory:</strong> Various bonuses</li>
          </ul>
    ...
    },
    {
      ...
      contentRu: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Социальные:</strong> Подписка на соцсети, приглашение друзей</li>
            <li><strong>Игровые:</strong> Достижения в подземельях, сбор ресурсов</li>
            <li><strong>Ежедневные:</strong> Обновляются каждый день</li>
          </ul>
      ...
      contentEn: (
        <div className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-2 ml-2">
            <li><strong>Social:</strong> Follow social media, invite friends</li>
            <li><strong>Game:</strong> Dungeon achievements, resource gathering</li>
            <li><strong>Daily:</strong> Reset every day</li>
          </ul>
