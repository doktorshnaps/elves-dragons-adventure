...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      pvp_seasons: {
        Row: {
          ...
          id: string
          is_active: boolean
          league_rewards_config: Json | null
          name: string
          rewards_config: Json
    ...
    Functions: {
      ...
      admin_delete_treasure_hunt_event: {
        Args: { p_admin_wallet: string; p_event_id: string }
        Returns: Json
      }
      ...
      admin_toggle_treasure_hunt_event: {
        Args: {
          p_activate: boolean
          p_admin_wallet: string
          p_event_id: string
      ...
      check_is_current_user_admin: { Args: never; Returns: boolean }
