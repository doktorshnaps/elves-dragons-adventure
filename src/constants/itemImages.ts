...
const archmageSoulShard = "/placeholder.svg";
const progenitorHeart = "/placeholder.svg";
const arachneSilkGland = "/placeholder.svg";
const progenitorEgg = "/placeholder.svg";
const primasEye = "/placeholder.svg";
const arachneClaw = "/placeholder.svg";
const arachneCrown = "/placeholder.svg";
const ashenThreadsCloak = "/placeholder.svg";
